...
- Name: todo.spec.js >> Todo App >> Stats bar shows correct counts
- Location: e2e/todo.spec.js:118:2
...
Locator: locator('text=Active')
Expected: visible
Error: strict mode violation: locator('text=Active') resolved to 2 elements:
    1) <span class="mt-1 text-sm">Active</span> aka locator('span').filter({ hasText: 'Active' })
    2) <option value="active" class="svelte-ju2naq">Active</option> aka getByLabel('Filter by status')
            ...
            - list [ref=e99]:
                - listitem [ref=e101]:
                    ...
                    - generic [ref=e107]:
                        ...
                        - generic [ref=e109]:
                            - generic [ref=e110]:
                                - heading "Task A" [level=3] [ref=e111]
                ...
                - listitem [ref=e124]:
                    ...
                    - generic [ref=e130]:
                        ...
                        - generic [ref=e132]:
                            - generic [ref=e133]:
                                - heading "Task B" [level=3] [ref=e134]
